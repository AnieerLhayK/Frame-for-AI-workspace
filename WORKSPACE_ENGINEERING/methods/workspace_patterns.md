...
`WORKSPACE_ENGINEERING/methods/skill_engineering/`.
...
The workspace bootstrap (`scripts/workspace/bootstrap_workspace.py`) uses bounded discovery:
...
- **MERGE** what has a better home (architecture → root `ARCHITECTURE.md`;
  coding style → `WORKSPACE_ENGINEERING/methods/skill_engineering/style_alignment.md`;
