...
maintainer must invoke `scripts/publishing/sync_public_projections.py --push` with an
...
`shared/governance/agent_registry.yaml`, which records status, registration type, aliases,
