...
def test_candidates(path: str) -> list[str]:
    ...
    if normalized.startswith("scripts/") and normalized.endswith(".py"):
        ...
        test_groups = {
            ...
            "resolve_task_context": "workspace",
            "session_continuity": "workspace",
            "skill_lifecycle": "workspace",
            "task_records": "workspace",
            "verify_change_scope": "workspace",
            "workflow_check": "workspace",
            "workspace_cli": "workspace",
            "workspace_explain": "workspace",
            "workspace_health": "workspace",
            "workspace_launcher": "workspace",
        ...
        group = test_groups.get(stem)
        if group:
            candidates.append(f"scripts/tests/{group}/test_{stem}.py")
